...
+-------+------------------+------+-----+---------+----------------+
        ...
        -- 向classes表中插入 一个班级
	    insert into classes values(1,"python19");
...
+--------+-------------------------------------+------+-----+---------+----------------+
        ...
        insert into students(name,high,gender) values("吴彦祖",188.88,"男");

        -- 多行插入
		insert into students values(0,"老谢",28,188.88,1,110),(0,"老李",18,155.55,1,110);
